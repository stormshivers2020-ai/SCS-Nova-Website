...
export function BCaurisHero() {
  return (
    <section
      id="b-cauris"
      className="relative flex min-h-[100dvh] flex-col border-t border-white/[0.06] bg-black"
        ...
        <div className="container-brand w-full">
          <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16 xl:gap-24">
            <div className="order-2 lg:order-1">
              <p className="animate-fade-up font-mono text-xs font-medium uppercase tracking-[0.24em] text-zinc-500 opacity-0 [animation-delay:0.08s] [animation-duration:1s] [animation-fill-mode:forwards] sm:text-sm sm:tracking-[0.22em]">
                B-Cauris
              </p>
              <h2
              ...
              <p className="animate-fade-up mt-8 max-w-xl text-pretty text-base font-medium leading-relaxed text-zinc-300 opacity-0 [animation-delay:0.22s] [animation-duration:1s] [animation-fill-mode:forwards] sm:mt-10 sm:text-lg sm:leading-relaxed lg:max-w-2xl">
                B-Cauris is a work intelligence companion that learns through real activity —
                messages, files, screenshots, recurring tasks, and decisions over time. It helps
                transform everyday work into structured operational memory, pattern recognition, and
                guidance.
              </p>
